describe ('InviaTravel Page Test', function ()
{
    ...
    it('QA Automation Task', function(){
       ...
       locsel.click();
       var date1 = element(by.xpath('((((.//div[@class=\'_input-box _input-box-icon-set _input-box-size- _input-box-datePickerTwoInputs datepicker-startpage\']))[2])/div/div/div/input)[1]'));
       waitForElement(date1);
       date1.clear();
       date1.sendKeys('25.11.2019');
       browser. sleep(3000);
       var date2 = element(by.xpath('((((.//div[@class=\'_input-box _input-box-icon-set _input-box-size- _input-box-datePickerTwoInputs datepicker-startpage\']))[2])/div/div/div/input)[2]'));
       waitForElement(date2);
       date2.clear();
       date2.sendKeys('29.11.2019');
       browser.sleep(3000);
